...
- From our graph {D2}, we can observe there is a slight correlation between presence of view quality and sale price, as on average, housing with view quality data sold for a value 1.59 times greater than homes with no view quality description. This is confirmed by our Pearson correlation coefficient, calculated to be 0.2564431. 

- Outliers can be seen in graph {D3} for those without view quality, as some sale prices were above 6 million. However due to the existence of 8960 other housing sales without view quality, the mean sale price for housing without view quality remains at a much lower value of 449,850. Thus, due to the size of the bin, the existence of these outliers does not impact out overall analysis.
