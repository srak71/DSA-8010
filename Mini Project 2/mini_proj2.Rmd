...
- From our graph {C4}, we can conclude that number of bedrooms has a slight association with sale price based on its Pearson Correlation (R = 0.21). Due to the multimodal properties of graph {C2}, we can reasonably hypothesize that properties sold with 
...
- From our graph {D2}, we can observe there is a slight correlation between presence of view quality and sale price, as on average, housing with view quality data sold for a value 1.55 times greater than homes with no view quality description. This is confirmed by our Pearson correlation coefficient, calculated to be 0.2391971.

- Outliers can be seen in graph {D3} for those without view quality, as some sale prices were above 6 million. However due to the existence of 8960 other housing sales without view quality, the mean sale price for housing without view quality remains at a much lower value of 447,655. Thus, due to the size of the bin, the existence of these outliers does not skew out overall analysis.
