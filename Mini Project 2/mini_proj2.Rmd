...
- The summary statistics {D1} show that the mean sale price for homes with a view is 696,077 compared to 447,655 for those without. The difference in median sale price is even more substantial, with homes having a view getting a median of 665,000 compared to 410,000 for those without. From our graph {D2}, on average housing with existing view quality data sold for a value 1.55 times greater than homes with no view quality description.  This suggests that a view is a premium feature that can increase the value of a property, and is confirmed by our Pearson Correlation Coefficient, calculated to be 0.2391971.
