...
**Answer: Under the hypothesis $H_0:\pi=0.5; \quad H_A: \pi > 0.5.$, we find the test statistic to be $|z_0|=3.341$ and the p-value = 0.0004177. Thus the null is rejected in favor of the alternative- more than 50% of white mushrooms are edible.**
...
```{r exercise4}
conf_interval <- function(n, x, alpha) {
  p <- x / n
