...
<center>![](Screenshot 2024-10-10 134613.png){width=50%}
...
```{R echo=FALSE}
cat(">>> q_95 == round(expected_answer, 3)\n",
    q_95 == round(expected_answer, 3))
```

<span style="color: red;">No, it is not giving the correct exact answer.</span>
...
<span style="color: red;">No! Our function is giving unique but close answers for each run.</span>
