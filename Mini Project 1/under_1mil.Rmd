...
- Unlike houses that are sold for under $1M, for sales over $1M, there are an extremely small amount of purchases for properties with no bathrooms. This again can be explained by the client purchasing an undeveloped area of land which may have no bedooms or bathrooms. Also, sales price stays relatively constant even with the addition of bathrooms, showing that the amount of bathrooms in a house may not be a big factors for home-seekers willing to pay over $1M.
...
```{R, echo=FALSE}
  # Plot distribution of year built for houses under $1M
    ...
    kable(year_built_summary2, 
          ...
          align = "c")
```
- Similar to houses under $1M, our distribution is left-skewed, showing that reguardless of purchacing budgets, home-seekers prefer to purchace newly developed housing. 
